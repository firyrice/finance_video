...
4. **风格词**：professional financial thumbnail, high contrast, bold typography, cinematic lighting, eye-catching, 4k
5. **排版要求**：文字清晰不被遮挡、主体不要太满、留出文字空间
...
Below it smaller Chinese text: "用财报算清楚".
...
- gpt-image-2 生成的中文偶尔会有错别字，生成后**检查图上文字是否正确**，错了就调整提示词重生成，或建议用户后期用设计工具替换文字。
